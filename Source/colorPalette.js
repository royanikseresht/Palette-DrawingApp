...
function colorPalette(){
    ...
    this.get_random_palette = function(){
        var idx = Math.floor(Math.random() * this.palette.length); 
        return this.palette[idx]
    }

    this.get_name_of_palette = function(palette){
        return this.palette_names[this.palette.indexOf(palette)]
    }

    this.get_color_from_name = function(palette){
        return this.palette[this.palette_names.indexOf(palette)]
    }
}